...
!
!       To Do...
!               -- Derive the expression for the T's.. 
!               -- Determine at what point an energy correction become
!               significant.
!        
!
!       --------------------------------------------------------------------------- 
...
!       subroutine.
        ...
        Write(*,*) 'After get command arg, M=', trim(M)
...
!               5. The 1 and 2 electron energy
        ...
        Write(*,*) '  '
        Write(*,*) 'SUB-STEP: Loading information from', Commandline 
