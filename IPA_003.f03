...
!       that are given to the program.This will use a subroutine found
!       at the end of this code that is designed to collect/calculate
!       all of the basic information one might want from each of their
!       output files.
